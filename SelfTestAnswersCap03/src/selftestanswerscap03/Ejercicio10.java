...
/*R= C Y F ya que se refiere a un objeto de tipo "Dozens array" y cada 
objeto Dozen que se crea viene con su propio objeto "int array".
Cuando se alcanza la línea 14, solo el segundo objeto Dozen (y su objeto 
"int array") no son accesibles.
*/